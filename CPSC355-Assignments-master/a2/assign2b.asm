...
main:		stp x29, x30, [sp, -16]								// Save FP and LR to stack, allocating 16 bytes, pre-increment SP
		...
		movk multiplicand_r, 0x1f1f, lsl 0 						// Initialize "multiplicand" variable with the value 522133279. Place the first half of 0x1f1f1f1f in.
		movk multiplicand_r, 0x1f1f, lsl 16 						// Place remainder of "0x1f1f1f1f" in.
		mov multiplier_r, 200								// Initialize "multiplier" variable with the value 200.
