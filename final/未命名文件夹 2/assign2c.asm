...
main:		
        ...
        mov multiplicand_s, -252645136                 // Initialize "multiplicand_s" variable with the value -252645136. Place the first half of 0xFEFEFEFE in.
		mov multiplier_s, -256					  // Initialize "multiplier_s" variable with the value -256.
