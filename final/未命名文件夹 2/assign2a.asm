...
main:		
        ...
        mov multiplicand_s, -16843010                 // Initialize "multiplicand_s" variable with the value -16843010. Place the first half of 0xFEFEFEFE in.
		mov multiplier_s, 70						  // Initialize "multiplier_s" variable with the value 70.
